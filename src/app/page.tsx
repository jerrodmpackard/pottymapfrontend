...
export default function Home() {
  ...
  return (
      <div className="grid grid-flow-row justify-center align-middle mt-12">
        <div className="bg bg-white  min-w-96 p-8 rounded-lg grid grid-flow-row justify-center align-middle">
          <h1 className="text-[48px] flex justify-center text-[#1283C8]">Potty Map</h1>
          <h1 className="flex justify-center text-[24px] text-black mt-4">{switchBool ? 'Create an account' : 'Find bathroom near you'}</h1>
      ...
      <Button className="mt-2 mb-2 text-white bg-[#1283C8] w-[240px]" onClick={handleSubmit}>Submit</Button>
      </div>
      <div className="grid grid-flow-col-dense">
        ...
        <Button className="underline text-black bg-white">Continue as guest</Button>
      </div>
      <div>
